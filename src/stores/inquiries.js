...
export const useInquiriesStore = defineStore('inquiries', () => {
  ...
  const updateInquiry = async (id, payload) => {
    ...
    const updatePayload = {
      ...
      ...(payload.guest_email !== undefined && { guest_email: payload.guest_email?.trim() || null }),
      ...(payload.guest_nationality !== undefined && { guest_nationality: payload.guest_nationality || null }),
      ...(payload.guest_document_type !== undefined && { guest_document_type: payload.guest_document_type || null }),
      ...(payload.guest_document_number !== undefined && { guest_document_number: payload.guest_document_number?.trim() || null }),
      ...(payload.guest_gender !== undefined && { guest_gender: payload.guest_gender || null }),
      ...(payload.guest_birth_date !== undefined && { guest_birth_date: payload.guest_birth_date || null }),
